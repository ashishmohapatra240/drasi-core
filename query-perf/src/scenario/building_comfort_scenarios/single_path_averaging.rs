...
const SCENARIO_NAME: &str = "single_path_averaging_projection";
...
pub struct SinglePathAveragingProjectionScenario {
    model: Arc<BuildingComfortModel>,
    config: PerformanceTestScenarioConfig,
}

impl SinglePathAveragingProjectionScenario {
    pub fn new(
        iterations: Option<u128>,
        seed: Option<u64>,
    ) -> SinglePathAveragingProjectionScenario {
...
impl PerformanceTestScenario for SinglePathAveragingProjectionScenario {
