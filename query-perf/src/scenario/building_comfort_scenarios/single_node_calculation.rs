...
const SCENARIO_NAME: &str = "single_node_calculation_projection";
...
pub struct SingleNodeCalculationProjectionScenario {
    model: Arc<BuildingComfortModel>,
    config: PerformanceTestScenarioConfig,
}

impl SingleNodeCalculationProjectionScenario {
    pub fn new(
        iterations: Option<u128>,
        seed: Option<u64>,
    ) -> SingleNodeCalculationProjectionScenario {
...
impl PerformanceTestScenario for SingleNodeCalculationProjectionScenario {
