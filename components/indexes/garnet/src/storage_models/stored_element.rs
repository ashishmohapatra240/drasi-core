...
impl StoredElementContainer {
    pub fn new(element: StoredElement) -> Self {
        StoredElementContainer {
...
impl StoredElement {
    ...
    pub fn get_metadata(&self) -> &StoredElementMetadata {
        match self {
            StoredElement::Node(e) => &e.metadata,
            StoredElement::Relation(e) => &e.metadata,
        }
    }
}
